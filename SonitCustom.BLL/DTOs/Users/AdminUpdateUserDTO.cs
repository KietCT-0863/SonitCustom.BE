...
{
    /// <summary>
    /// DTO dùng để cập nhật thông tin người dùng (do admin thực hiện)
    /// </summary>
    public class AdminUpdateUserDTO
    {
        ...
        /// <summary>
        /// ID Role mới (null nếu không cập nhật)
        /// </summary>
        /// <remarks>Phải là ID của Role đã tồn tại trong hệ thống</remarks>
